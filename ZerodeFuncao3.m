...
##  j=k*k;
  ...
  Keq2=k.*(-Li.*(2.*u.-2*h).*(h.-u).*(u.^2.-2*h.*u.+h*h+d*d).^(3./2).-d*d.*(h.-(u.^2.-h*2.*u.+h*h+d*d).^(1./2)).*(u.^2.-h*2.*u.+h*h+d*d))./(u.^2.-2*h.*u.+h*h+d*d).^(5./2);
  Keq2;
  ...
  KnoEqEst=k.*(-Li.*(2.*z1.-2*h).*(h.-z1).*(z1.^2.-2*h.*z1.+h*h+d*d).^(3./2).-d*d.*(h.-(z1.^2.-h*2.*z1.+h*h+d*d).^(1./2)).*(z1.^2.-h*2.*z1.+h*h+d*d))./(z1.^2.-2*h.*z1.+h*h+d*d).^(5./2);
